...
class Metrics:
    ...
    def __init__(self, plot_dir="plots_efficientnet", box_bins=10, unscale_fn=None):
    ...
    def _save_best_val_plots(self):
        ...
        fig.tight_layout()
        plt.savefig(os.path.join(self.plot_dir, "finetune_hodapp_efficientnet_best.png"), dpi=150)
        plt.close()
        # 3) Confusion matrix
        fig, ax = plt.subplots(1, 1, figsize=(6, 5))
        self._hodapp_confusion_panel(ax, gt_db, pred_db, tag)
        fig.tight_layout()
        plt.savefig(os.path.join(self.plot_dir, "finetune_confusion_efficientnet_best.png"), dpi=150)
        plt.close()
    ...
    def plot_scatter(self):
        ...
        fig.tight_layout()
        plt.savefig(os.path.join(self.plot_dir, "finetune_hodapp_efficientnet.png"), dpi=120)
        plt.close()
        ...
        fig.tight_layout()
        plt.savefig(os.path.join(self.plot_dir, "finetune_confusion_efficientnet.png"), dpi=120)
        plt.close()
    ...
    def save_epoch_scatter(self, val_preds, val_gts):
        ...
        self._hodapp_scatter_panel(ax, gt_db, pred_db, tag)
        fig.tight_layout()
        plt.savefig(os.path.join(self.plot_dir, f"finetune_hodapp_efficientnet_epoch{self.epoch}.png"), dpi=150)
        plt.close()
        # 3) Confusion matrix
        fig, ax = plt.subplots(1, 1, figsize=(6, 5))
        self._hodapp_confusion_panel(ax, gt_db, pred_db, tag)
        fig.tight_layout()
        plt.savefig(os.path.join(self.plot_dir, f"finetune_confusion_efficientnet_epoch{self.epoch}.png"), dpi=150)
        plt.close()
